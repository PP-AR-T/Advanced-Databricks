...
# MAGIC
# MAGIC In this lab we will be working on Exploding join between 3 tables, Transactions, Stores and Countries to identify Spill induced by exploding join, and gradually improve performance of application.
